...
Usage: GH_AUTH=<gh-pat> python set-gh-secret.py <vault-entry-title> <SECRET_NAME>
"""
import base64
import json
import os
...
OWNER = "geograhic"
REPO = "anki-browser"
KEEPASS_DIR = r"C:\Users\LJL\Li_System\Password_Manager\20260714_KEY1_AI全自动开发授权"
READ_KEY = KEEPASS_DIR + r"\read_key.py"
PY = sys.executable


def main():
    if len(sys.argv) != 3:
        print("usage: GH_AUTH=<gh-pat> set-gh-secret.py <vault-entry-title> <SECRET_NAME>")
        sys.exit(2)
